...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<script>
		...
		function checkForm()
		{
			...
			t3=document.getElementsByName('password1')[0];
                        t4=document.getElementsByName('password2')[0]; 
...
p.agreement label{
    ...
    <form method=post action="dealerregisprocess.jsp" onreset="return abc()" onsubmit="return checkForm()"  >
            ...
            <fieldset class="row2">
               <span class="button" id="toggle-login">Personal Detail</span>
                <p>
                    ...
                    <input type="text" class="long" name="dname" id="dname">
                </p>
                 <p>
                    <label>Dealer Id *
                    </label>
                    <input type="text" class="long" name="did" id="did">
                </p>
                <p>
                    <label>Phone *
                    </label>
