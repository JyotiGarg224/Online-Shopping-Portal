...
String qry="select * from customer where cid='"+session.getAttribute("userid")+"'";
    ...
    <body>
        ...
        <%@include file="header.jsp" %>
             <%@include file="category.jsp" %>
                           ...
                           <form method=post action="cusupdateformprocess.jsp" onreset="return abc()" onsubmit="return checkForm()"  >
            ...
            <fieldset class="row2">
               <span class="button" id="toggle-login">Personal Detail</span>
                <p>
                    ...
                    <input type="text" name="cname" id="cname" value="<%= rs.getString("cname") %>">
                </p>
                 <p>
                    <label>Customer Id *
                    </label>
                    <input type="text" name="cid" id="cid" readonly value="<%= rs.getString("cid") %>" >
                </p>
                <p>
                    <label>Phone *
                    </label>
